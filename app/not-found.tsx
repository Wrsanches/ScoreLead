...
//
// Visually it mirrors app/[locale]/error.tsx so 404 and 500 read as a pair.
      ...
      <body className={`${geist.className} antialiased`}>
        ...
        >
          ...
          <p className="text-sm text-zinc-500 mb-10 text-center max-w-sm leading-relaxed">
            The page you are looking for does not exist or has moved. Head back to the homepage
