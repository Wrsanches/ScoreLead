...
> = {
  new:            { label: "New",            dot: "bg-emerald-400", text: "text-emerald-700 dark:text-emerald-300", bg: "bg-emerald-500/10", ring: "ring-emerald-500/25" },
  contacted:      { label: "Contacted",      dot: "bg-sky-400",     text: "text-sky-700 dark:text-sky-300",     bg: "bg-sky-500/10",     ring: "ring-sky-500/25" },
  interested:     { label: "Interested",     dot: "bg-amber-400",   text: "text-amber-700 dark:text-amber-300",   bg: "bg-amber-500/10",   ring: "ring-amber-500/25" },
  no_profile:     { label: "No profile",     dot: "bg-zinc-500",    text: "text-zinc-700 dark:text-zinc-300",    bg: "bg-zinc-200/60 dark:bg-zinc-800/60",    ring: "ring-zinc-700/60" },
  not_interested: { label: "Not interested", dot: "bg-rose-400",    text: "text-rose-700 dark:text-rose-300",    bg: "bg-rose-500/10",    ring: "ring-rose-500/25" },
  customer:       { label: "Customer",       dot: "bg-emerald-300", text: "text-emerald-700 dark:text-emerald-200", bg: "bg-emerald-500/15", ring: "ring-emerald-400/35" },
}
