  ...
  const enrichmentFields = [
    {
      icon: Globe,
      label: t("website"),
      value: "sunsetyoga.com",
      color: "text-blue-400",
    },
    {
      icon: Mail,
      label: t("email"),
      value: "hello@sunsetyoga.com",
      color: "text-zinc-300",
    },
    {
      icon: Phone,
    ...
    >
      ...
      <div className="w-full flex justify-center px-6">
        <div className="w-full max-w-5xl">
          ...
          >
            <div
              className="w-full max-w-[90%] md:max-w-180"
              style={{
                perspective: "900px",
                userSelect: "none",
              ...
              >
                ...
                <div className="bg-zinc-800/50 border border-zinc-700 rounded-t-xl px-5 py-4 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    {[t("sourceMaps"), t("sourceWeb"), t("sourceAI")].map(
                      (source) => (
                        <span
                          key={source}
                ...
                <div className="bg-zinc-900/80 border border-t-0 border-zinc-700 rounded-b-xl py-2">
                  {enrichmentFields.map((field) => (
                    ...
                    >
                      ...
                      <span className="text-zinc-500 text-sm w-20">
                        {field.label}
                      </span>
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      >
                        <span className="text-zinc-500 text-xs w-28">
                          {signal.label}
                        </span>
                        ...
                        <span className="text-zinc-400 text-xs w-6 text-right">
                          {signal.value}/5
                        </span>
                      </div>
                    ))}
              ...
              <div className="border-b md:border-t border-zinc-800/60 pt-8 px-6 pb-10 md:pt-12 md:pl-12 md:px-0 md:pb-16">
                ...
                <div className="bg-zinc-900/30 border border-zinc-800/60 rounded-xl p-5 font-mono text-sm">
                  <div className="space-y-4">
                    ...
                    <div>
                      <div className="flex items-center gap-2 mb-2">
                        <div className="w-5 h-5 rounded-full bg-amber-500/20 flex items-center justify-center text-[10px] text-amber-400 font-bold">
                          2
                        </div>
                        <span className="text-zinc-400 text-xs">
                          {t("outreachStep2Label")}
                        </span>
                      </div>
                      <div className="bg-zinc-800/40 rounded-lg p-3">
                        <p className="text-zinc-500 text-xs mb-1">
