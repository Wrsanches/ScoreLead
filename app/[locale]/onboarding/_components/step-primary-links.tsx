...
interface StepPrimaryLinksProps {
  defaultValues?: PrimaryLinksValues
  onSubmit: (data: PrimaryLinksValues) => void
  onBack: () => void
}

const EASE = [0.25, 0.46, 0.45, 0.94] as const

export function StepPrimaryLinks({ defaultValues, onSubmit, onBack }: StepPrimaryLinksProps) {
